...
def create_env(env_name=config.game_name+config.env_type, noop_start=True, clip_rewards=True,testing=False):

    env = gym.make(env_name,frame_skip=config.frame_skip,test=testing)
